...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    //    picImageView.image = [UIImage imageNamed:@""];
        ...
        UILabel *upTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(picImageView.right+10, 30, frame.size.width-67-picImageView.right-10, 11)];
        ...
        UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(picImageView.right+10, 44, frame.size.width-67-picImageView.right-10, 10)];
        ...
        UILabel *stateTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(bottomView.right+12, 44, frame.size.width-bottomView.right-12, 10)];
