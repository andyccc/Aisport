...
- (instancetype)init
{
    return [self initWithType:AlignWithCenter betweenOfCell:UIValue(10)];
}
...
{
    return [self initWithType:cellType betweenOfCell:UIValue(10)];
}
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    {
        UICollectionViewLayoutAttributes *currentAttr = [layoutAttributes objectAtIndex:index]; // 当前cell的位置信息
        UICollectionViewLayoutAttributes *previousAttr = index == 0 ? nil : [layoutAttributes objectAtIndex:index - 1]; // 上一个cell 的位置信
        UICollectionViewLayoutAttributes *nextAttr = index + 1 == layoutAttributes.count ?
        nil : [layoutAttributes objectAtIndex:index + 1];//下一个cell 位置信息
...
- (void)setCellFrameWith:(NSMutableArray *)layoutAttributes
{
    ...
    switch (_cellType)
    {
        ...
        case AlignWithRight:
            ...
            {
                UICollectionViewLayoutAttributes *attributes = [layoutAttributes objectAtIndex:index];
                CGRect nowFrame = attributes.frame;
